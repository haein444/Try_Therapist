...
$qry = $conn->query("SELECT * FROM therapists_schedule where therapists_id =".$_GET['did']);
$c = $qry->num_rows;
...
<div class="container-fluid">
	<form  id="manage-schedule">
		<input type="hidden" name="therapists_id" value="<?php echo $_GET['did'] ?>">
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-12">
			<table class="table">
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					title.replace("Edit ",'')
					end_load()
					uni_modal(title,'view_therapists_schedule.php?id=<?php echo $_GET['did'] ?>')
				}
			}
		})
	})
