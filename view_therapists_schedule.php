...
<?php 
	...
	$qry = $conn->query("SELECT * FROM therapists_schedule where therapists_id=".$_GET['id']);
?>
...
<script>
	$('#edit').click(function(){
		uni_modal("Edit "+$('#uni_modal .modal-title').html(),'manage_therapists_schedule.php?did=<?php echo $_GET['id'] ?>','mid-large');
	})
</script>